/* ************************************************************************
   ...
   Authors:
     * Jonathan Weiss (jonathan_rass)

************************************************************************ */

qx.Class.define("gtmweb.LoginWindow",
{
  ...
  members :
  {
    ...
    checkInput : function()
    {
      var username = this.field1.getValue();
      var password = this.field2.getValue();
      
      if (username == null || password == null) {
          this.__effect.start();
          return false;
      }
      alert("ajax request here for login")
      // setting temp cookie which is invalid
      qx.bom.Cookie.set("LOGINNAME", "LOREMIPSUM");
      qx.bom.Cookie.set("MD5HASHOFSOMETHING", "LOREMIPSUM");
    ...
    main: function()
    {
      ...
      var field2 = new qx.ui.form.PasswordField();
       ...
       this.__container.add( new qx.ui.basic.Image("resource/gtmweb/icon/128/utilities-keyring.png") ,
        {row: 0, column : 1});
